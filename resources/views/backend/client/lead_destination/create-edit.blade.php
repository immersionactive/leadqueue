        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    {{--
                    email: can't find; emailed USADATA
                    income level: investmentsandassets.estimatedIncomeMin and investmentsandassets.estimatedIncomeMax
                    recent home buyer: mortgagesandloans.recentHomeBuyer
                    gender: basicdemographics.gender
                    phone: can't find; emailed USADATA
